		...
		if(!rs.isEmpty()){
			for(I o:rs){
				...
				case 12:
					...
					break;
				case 139:
					page.Out("<div class=post><a href=/"+w+"><img src=/icons/"+w+" class=icon></a><div><a href=/"+w+"/steps>Steps</a><div class=graf style=height:100px>"+o.getQuotation()+"</div><div class=c2 t="+o.getModifyTick()+"></div><a href=/post?re="+i+"&jmp=%2F>Re</a></div></div>");
					break;
				default:
