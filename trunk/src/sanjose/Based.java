	...
	public Based(String plink,Page page) throws IOException{
		...
		if(s.length>2){
			...
			if(n.equalsIgnoreCase("upload")){
				new Upload().Out(plink,page);
				return;
			}
		}
		page.title=plink;
		page.aside="<ul><li><a href=/post>Post</a></ul><ul><li><a href=/system/settings>Settings</a><li><a href=/12.3/profile>Profile</a><li><a href=/12.3/contacts>Contacts</a><li><a href=/12.3/tags>Tags</a></ul><ul><li><a href=/12.3/dashboard>Dashboard</a><li><a href=/12.3/activities>Activities</a><li><a href=/12.3/historical>Historical</a></ul><ul><li><li><a href=/12.3/weight>Weight</a><li><a href=/12.3/heartrate>Heart Rate</a><li><a href=/12.3/steps>Steps</a><li><a href=/12.3/fat>Fat</a><li><a href=/12.3/upload>Upload</a></ul>";
		int i;
		for(i=0;i<10;i++)
			page.Out("<h2>Based</h2>sqsq.");
	}
}